    ...
    <div class="container">
      ...
      <nav>
        <ul>
          ...
          <li  class="current"><a href="notification.php" class="m3">Notification</a></li>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo  "Date:  " . $row["NDate"]. "           " . "Time:  " . $row["NTime"]. "<br>" ."sub:  " . $row["Subject"]."<br>" ."Notification:  ". $row["Text"]. "<br> <br> <br>";
	}
} else {
    echo "0 results";
}
