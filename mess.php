    ...
    <div class="container">
      ...
      <nav>
        <ul>
          ...
          <li class="current"><a href="mess.php" class="m4">Mess Menu</a></li>
...
$HID=$_SESSION['user'];
$query="select MessID from hostelier where HID=$HID";
$result1=$conn->query($query);
$row= mysqli_fetch_row($result1);
$MID= $row[0];


$query="SELECT `Day`,`Time`,`Dish` FROM mess where MessID='$MID' ";
