...
$sql = "SELECT sNo,HID,oAddress,oContact,Date_ADd(fromDate,interval `nod_count` Day) from hleave";
...
<table >
<tr><th>Serial No</th><th>Roll Number</th><th>OutGoing Address</th><th>OutGoing Contact</th><th>Return Date</th></tr>
_END;
for ($j = 0 ; $j < $rows ; ++$j)
{
