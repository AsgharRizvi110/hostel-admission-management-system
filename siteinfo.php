    ...
    <div class="container">
      ...
      <nav>
        <ul>
          ...
          <li class="current last"><a href="siteinfo.php" class="m5">Hostel Information</a></li>
        </ul>
      </nav>
 </div>
  <style>
  ...
  <div class="container">
    <aside>
      ...
      <ul class="categories">
        ...
        <li ><span><a href="index1.php">Calendar</a></span></li>		
    ...
    <p>
	  <i>
	  <b>
		This Hostel Management and Allotment System is Developed by Nida Zehra and Nighat Zehra to provide web-based portal between Hostellers and Warden of FAST UNIVERSITY. It is tried
