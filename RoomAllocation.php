...
if (!$conn) {
 ...
 $sql = "update hostelier set FloorNo=$FloorNo,RoomNo=$RoomNo where HID = $hid;";
 ...
 echo <<<_END
 Please Update the Room Details for $name!!!
 <form action="RoomAllocation.php" method="post">
 <input type="hidden" name="HID" value="$HID">
<input type="text" name="floorno" value="NEW FLOOR NUMBER">
<input type="text" name="roomno" value="NEW ROOM NUMBER">
...
if($_POST===array()){
$query="Select HID,HName,FloorNo,RoomNo from hostelier";
...
<table>
<tr><th>ID</th><th>NAME</th><th>FLOOR NUMBER</th><th>ROOM NUMBER</th><th></th></tr>
_END;
for ($j = 0 ; $j < $rows ; ++$j)
{
...
<td><input type="submit" name="modify" value="MODIFY"></td></tr></form>
_END;
