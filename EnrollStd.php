...
$sql = "INSERT INTO `hams`.`hostelier` (`HID`,`Hpassword`,`Hemail`,`BDate`,`Heducation`,`Haddress`,`HNIC`,`HName`,`enrollDate`,`Degree`,`messID`,`FloorNo`,`RoomNo`,`contact`)
 VALUES ('$b', '$c', '$d', '$f', '$e', '$g','$h','$a','$i','$deg','$j','$k','$l','$z')";
...
$to_email = $d;
$subject = "Enrollment of hostelie";
$body = "you are enrolled in the hostel 
id=$b
password=$c
floor=$k
room=$l
please maintain the dicipline ";
$headers = "From: s.m.a.rshah110@gmail.com";
